...
export class GamesDetailsComponent implements OnInit {
    ...
    constructor(private _router: Router,
                ...
                private _excelService: BaseExcelService) {
    }
    ...
    public getFromExcel(): void {
        this._excelService.getValueFromSelection().subscribe(value => {
            this.details.patchValue({name: value});
        });
    }
